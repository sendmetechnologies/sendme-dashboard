...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const fullHeightRoutes = ["/dashboard/orders", "/dashboard/live-tracker", "/dashboard/schedules", "/dashboard/return-load", "/dashboard/drivers", "/dashboard/organizations", "/dashboard/marketers", "/dashboard/vehicles", "/dashboard/wallets-payments", "/dashboard/bids-pricing", "/dashboard/disputes", "/dashboard/approvals", "/dashboard/notifications", "/dashboard/email-campaigns"]
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-surface-secondary">
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <main className={`flex-1 min-h-0 ${isFullHeight ? "overflow-hidden" : "overflow-y-auto p-4 lg:p-6"}`}>
          {children}
        </main>
      </div>
    </div>
